                ...
                using (var reader = new StreamReader(file))
                {
                    ...
                    while ((line = reader.ReadLine()) != null)
                    {
                        ...
                        if (l.Length > 6)
                        {
                            ...
                            newProject.Activities.Add(new Items() { ITEMCODE = l[0], ITEMNAME = l[1], DEPT = l[2], PURCHASEPRICE = int.Parse(l[3]), SALESPRICE = int.Parse(l[4]), QTY = int.Parse(l[5]), EXPIREDATE = l[6], IMAGE = img });
                        }
                    }
                    reader.Close();
                }
